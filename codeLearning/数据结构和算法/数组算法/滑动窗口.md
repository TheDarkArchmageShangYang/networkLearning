...
- 2653.[滑动子数组的美丽值](https://leetcode.cn/problems/sliding-subarray-beauty/description/)(1786)
...
1456,643,1343,2379,209较为类似,为基础题,直接套用模板即可.

2090,1652需要对滑动窗口的窗口大小和边界进行讨论

1052,1423需要思考哪一部分应该用滑动窗口

1461,2841,2461,1297,567,438,76融入哈希表
